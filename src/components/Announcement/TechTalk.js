...
import image1 from '../PIC/Announcement/3.jpg';
...
const LogoDesigning = () => {
  ...
  return (
    <div className="announcement-detail-container">
      ...
      <h2 className="h2">Tech Talk</h2>
      <div className="announcement-content">
        <img src={image1} alt="Logo Designing" className="announcement-detail-image" />
        <div className="announcement-text">
          <p>
            We are excited to invite you to "Tech Talk," an IoT model expo organized by the DIET ACM members as part of IIC.
          </p>
